...
{{
  ...
  "card_title": "14-22자 (제목만 노출되고 한 줄로 표시됨 — 너무 길면 끝이 잘림. 핵심 사실을 한 문장에)",
  "hashtags": ["#인물명", "#작품/이벤트명", "#niche액션태그", "#분야태그", "#kpop"],
...
- [걸그룹 채널 한정] 걸그룹·여성 아이돌과 무관한 연예 뉴스 — 배우/드라마/영화/예능/트로트/
  보이그룹 단독 소식은 skip (걸그룹 멤버가 주체로 등장하는 경우만 예외)
...
★ decision == "post" — 일반 카피 (save / share-worthy 지향)
- 인물명/팀명/작품명/숫자를 앞에 배치. 한 문장으로 핵심 사실 + 맥락이 드러나도록.
- **save/share 가치를 의식할 것** — "친구에게 보여주고 싶은 한 줄", "북마크해두고 다시 보고 싶은 한 줄" 느낌
  * 정보 가치 우선: 누가 / 언제 / 어디서 / 무엇을 / 얼마나 — 구체적 숫자·날짜·작품명 우선
  * 추천/응원 톤이 어울리면 살짝 가미 (단, "안 본 사람 손해" 같은 직설 금지)
  * "예고" "공개" 같은 사실 표현 + "기대" "주목" 같은 응원 연결
- 좋은 예) "아이브, 5월 27일 정규 1집 'HER' 발매 — 글로벌 동시 공개"
- 좋은 예) "박찬욱 감독 신작 '미스트리스', 칸영화제 경쟁 부문 출품 확정"
- 좋은 예) "방탄 정국, AMA 무대 후 빌보드 핫 100 8주 연속 차트인"
- 허용 어휘: "공개", "예고", "포착", "출연", "콜라보", "달성", "기록", "선언", "발매", "확정", "주목", "기대", "리뉴얼"
- 금지 어휘 (자극형 클릭베이트): "충격", "발칵", "경악", "오열", "폭로", "이럴 수가", "결국", "도대체"
- 금지 어휘 (낚시 직설): "안 본 사람 손해", "당신만 모름", "역대급" — 자극 신호로 분류돼 down-rank
- 호기심 갭(?, ...)은 가능하되 남발 금지.
...
[hashtags] — 5-7개, mix tier 전략
- "niche-first": 첫 2-3개는 반드시 **구체적 고유명사** 기반.
  * 인물명: #뉴진스, #지드래곤, #박찬욱, #손흥민 (그룹/감독/선수 이름)
  * 작품명/이벤트명: #미스트리스, #월드투어, #칸영화제, #KBO
  * 트렌드 액션: #뉴진스컴백, #지디월드투어 (이름+상황 조합)
- 그 다음 1-2개는 **분야 일반**: #K연예, #케이팝, #드라마, #예능, #스포츠
- 마지막 1-2개는 **영문 broad**: #kpop, #kdrama, #korea
- 한국어/영문 mix. 띄어쓰기·특수문자 없음.
- 자극 키워드(#충격, #논란, #발칵 등) 금지.

★ niche 태그 = 검색·발견 가장 강한 시그널. 일반 분야 태그만 박으면 큰 경쟁풀에 묻혀서 도달 0.
인물/작품 이름을 정확히 박을수록 해당 팬덤·관심자 검색에 노출됨.
