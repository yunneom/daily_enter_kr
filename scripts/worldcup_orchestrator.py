...
SCHEDULE = [
    ...
    # === Day 2 (수 6/24) 07:00 — 32강 대진표 홍보 ===
    (datetime(2026, 6, 24,  7,  0, tzinfo=KST), "bracket",  ""),
    # === Day 5 (토 6/27) 07:00 — 16강 단독 대진표 홍보 ===
    (datetime(2026, 6, 27,  7,  0, tzinfo=KST), "bracket",  ""),
    # === Day 7 (월 6/29) 11:30 — 16강 홍보 블라스트 ===
    (datetime(2026, 6, 29, 11, 30, tzinfo=KST), "promo_blast", ""),
    # === Day 7 (월 6/29) 12:30 — HF 릴스 재시도 ===
    (datetime(2026, 6, 29, 12, 30, tzinfo=KST), "hf_blast",   ""),
    # === Day 7 (월 6/29) 13:25 — R16 집계·발표 + R8 빌드·게시 체인 ===
    (datetime(2026, 6, 29, 13, 25, tzinfo=KST), "chain_r16_r8", ""),
    # === Day 7 (월 6/29) 14:00 — R8 HF 대진표 1차 시도 (Playwright 수정 후) ===
    (datetime(2026, 6, 29, 14,  0, tzinfo=KST), "hf_r8", ""),
    # === Day 7 (월 6/29) 15:15 — R8 HF 대진표 2차 시도 (14:00 슬롯 4분 초과) ===
    (datetime(2026, 6, 29, 15, 15, tzinfo=KST), "hf_r8", ""),
    ...
    # === Day 4 (금 6/26) 12:00 — 16강 게시 ===
    (datetime(2026, 6, 26, 12,  0, tzinfo=KST), "publish",  "R16"),
    # === Day 7 (월 6/29) — 16강 집계 17:00 + 발표 17:30 + 8강 게시 18:00 ===
    ...
    # === Day 11 (금 7/3) 21:00 — 결승+3·4위전 게시 ===
    (datetime(2026, 7,  3, 21,  0, tzinfo=KST), "publish",  "R2"),
    # === Day 13 (일 7/5) — 결승 집계 + 🏆 우승 발표 ===
